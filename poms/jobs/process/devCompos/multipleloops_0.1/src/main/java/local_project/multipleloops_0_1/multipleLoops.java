...
package local_project.multipleloops_0_1;
 ...
 * @status
 */
public class multipleLoops implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (docsStaged != null) {
				...
				this.setProperty("docsStaged", docsStaged.toString());

			}

			if (notifsStaged != null) {

				this.setProperty("notifsStaged", notifsStaged.toString());

			}

			if (loopsToTake != null) {

				this.setProperty("loopsToTake", loopsToTake.toString());
		...
		public Boolean docsStaged;

		public Boolean getDocsStaged() {
			return this.docsStaged;
		}

		public Boolean notifsStaged;

		public Boolean getNotifsStaged() {
			return this.notifsStaged;
		}

		public Integer loopsToTake;

		public Integer getLoopsToTake() {
			return this.loopsToTake;
		}
	}
	...
	private final String jobName = "multipleLoops";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					multipleLoops.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(multipleLoops.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tLoop_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tLoop_2_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = multipleLoops.class.getClassLoader()
					.getResourceAsStream("local_project/multipleloops_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = multipleLoops.class.getClassLoader()
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(context.docsStaged ? "True" : "False");
				System.out.println(context.notifsStaged ? "True" : "False");
				...
				if (context.docsStaged && !context.notifsStaged) {
	...
	public void tLoop_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int looptLoop_1 = 1; looptLoop_1 <= context.loopsToTake; looptLoop_1 = looptLoop_1 + 1) {
					...
					System.out.println("Docs Path-tJava_2");
					System.out.println(context.docsStaged ? "True" : "False");
					System.out.println(context.notifsStaged ? "True" : "False");
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_multipleLoops = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_multipleLoops = new byte[0];

		public String tloop_error_message;

		public String getTloop_error_message() {
			return this.tloop_error_message;
		}

		public Integer tloop_current_value;

		public Integer getTloop_current_value() {
			return this.tloop_current_value;
		}

		public Integer tloop_currentIteration;

		public Integer getTloop_currentIteration() {
			return this.tloop_currentIteration;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_multipleLoops.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_multipleLoops.length == 0) {
						commonByteArray_LOCAL_PROJECT_multipleLoops = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_multipleLoops = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_multipleLoops, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_multipleLoops, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_multipleLoops, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_multipleLoops, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_multipleLoops) {

				try {

					int length = 0;

					this.tloop_error_message = readString(dis);

					this.tloop_current_value = readInteger(dis);

					this.tloop_currentIteration = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.tloop_error_message, dos);

				// Integer

				writeInteger(this.tloop_current_value, dos);

				// Integer

				writeInteger(this.tloop_currentIteration, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("tloop_error_message=" + tloop_error_message);
			sb.append(",tloop_current_value=" + String.valueOf(tloop_current_value));
			sb.append(",tloop_currentIteration=" + String.valueOf(tloop_currentIteration));
			sb.append("]");
	...
	public void tFixedFlowInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				context.docsStaged = (context.loopsToTake == (Integer) globalMap.get("tLoop_1_CURRENT_ITERATION"))
						? true
						: false;
				System.out.println(context.docsStaged ? "true end of first" : "false never set");
...
///////////////////////    			
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					row1.tloop_error_message = ((String) globalMap.get("tLoop_1_ERROR_MESSAGE"));

					row1.tloop_current_value = ((Integer) globalMap.get("tLoop_1_CURRENT_ITERATION"));

					row1.tloop_currentIteration = ((Integer) globalMap.get("tLoop_1_CURRENT_VALUE"));
...
///////////////////////		
					...
					if (row1.tloop_error_message != null) { //

						strBuffer_tLogRow_1.append(String.valueOf(row1.tloop_error_message));

					} //

					strBuffer_tLogRow_1.append("|");

					if (row1.tloop_current_value != null) { //

						strBuffer_tLogRow_1.append(String.valueOf(row1.tloop_current_value));

					} //

					strBuffer_tLogRow_1.append("|");

					if (row1.tloop_currentIteration != null) { //

						strBuffer_tLogRow_1.append(String.valueOf(row1.tloop_currentIteration));
	...
	public void tLoop_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int looptLoop_2 = 1; looptLoop_2 <= context.loopsToTake; looptLoop_2 = looptLoop_2 + 1) {
					...
					System.out.println("Notifs Path-tJava_4");
					System.out.println(context.docsStaged ? "True" : "False");
					System.out.println(context.notifsStaged ? "True" : "False");
...
///////////////////////    			
				...
				for (int i_tFixedFlowInput_2 = 0; i_tFixedFlowInput_2 < 1; i_tFixedFlowInput_2++) {
					...
					row2.tloop_error_message = ((String) globalMap.get("tLoop_2_ERROR_MESSAGE"));

					row2.tloop_current_value = ((Integer) globalMap.get("tLoop_2_CURRENT_ITERATION"));

					row2.tloop_currentIteration = ((Integer) globalMap.get("tLoop_2_CURRENT_VALUE"));
...
///////////////////////		
					...
					if (row2.tloop_error_message != null) { //

						strBuffer_tLogRow_2.append(String.valueOf(row2.tloop_error_message));

					} //

					strBuffer_tLogRow_2.append("|");

					if (row2.tloop_current_value != null) { //

						strBuffer_tLogRow_2.append(String.valueOf(row2.tloop_current_value));

					} //

					strBuffer_tLogRow_2.append("|");

					if (row2.tloop_currentIteration != null) { //

						strBuffer_tLogRow_2.append(String.valueOf(row2.tloop_currentIteration));
...
///////////////////////    			
	...
	public void tJava_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				context.docsStaged = false;
				context.notifsStaged = false;
	...
	public static void main(String[] args) {
		final multipleLoops multipleLoopsClass = new multipleLoops();

		int exitCode = multipleLoopsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = multipleLoops.class.getClassLoader()
					.getResourceAsStream("local_project/multipleloops_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = multipleLoops.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					context.setContextType("docsStaged", "id_Boolean");
					if (context.getStringValue("docsStaged") == null) {
						context.docsStaged = null;
					} else {
						try {
							context.docsStaged = routines.system.ParserUtils
									.parseTo_Boolean(context.getProperty("docsStaged"));
						} catch (NumberFormatException e) {
							System.err.println(String.format("Null value will be used for context parameter %s: %s",
									"docsStaged", e.getMessage()));
							context.docsStaged = null;
						}
					}
					context.setContextType("notifsStaged", "id_Boolean");
					if (context.getStringValue("notifsStaged") == null) {
						context.notifsStaged = null;
					} else {
						try {
							context.notifsStaged = routines.system.ParserUtils
									.parseTo_Boolean(context.getProperty("notifsStaged"));
						} catch (NumberFormatException e) {
							System.err.println(String.format("Null value will be used for context parameter %s: %s",
									"notifsStaged", e.getMessage()));
							context.notifsStaged = null;
						}
					}
					context.setContextType("loopsToTake", "id_Integer");
					if (context.getStringValue("loopsToTake") == null) {
						context.loopsToTake = null;
					} else {
						try {
							context.loopsToTake = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("loopsToTake"));
						} catch (NumberFormatException e) {
							System.err.println(String.format("Null value will be used for context parameter %s: %s",
									"loopsToTake", e.getMessage()));
							context.loopsToTake = null;
						}
					}
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("docsStaged")) {
				context.docsStaged = (Boolean) parentContextMap.get("docsStaged");
			}
			if (parentContextMap.containsKey("notifsStaged")) {
				context.notifsStaged = (Boolean) parentContextMap.get("notifsStaged");
			}
			if (parentContextMap.containsKey("loopsToTake")) {
				context.loopsToTake = (Integer) parentContextMap.get("loopsToTake");
			}
		}
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : multipleLoops");
		}
...
/************************************************************************************************
 * 96160 characters generated by Talend Open Studio for ESB on the March 8, 2023
 * at 8:49:18 AM EST
 ************************************************************************************************/