...
package local_project.jsonextract_0_1;
...
/**
 * Job: jsonExtract Purpose: using keys requiring escape chars<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class jsonExtract implements TalendJob {
	...
	private final String jobName = "jsonExtract";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jsonExtract.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = jsonExtract.class.getClassLoader()
					.getResourceAsStream("local_project/jsonextract_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = jsonExtract.class.getClassLoader()
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_jsonExtract = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_jsonExtract = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_jsonExtract.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_jsonExtract.length == 0) {
						commonByteArray_LOCAL_PROJECT_jsonExtract = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_jsonExtract = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_jsonExtract, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_jsonExtract, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_jsonExtract, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_jsonExtract, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_jsonExtract) {
	...
	public static class syntax1Struct implements routines.system.IPersistableRow<syntax1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_jsonExtract = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_jsonExtract = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(syntax1Struct other) {
	...
	public static class syntax2Struct implements routines.system.IPersistableRow<syntax2Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_jsonExtract = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_jsonExtract = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(syntax2Struct other) {
	...
	public void tFileInputRaw_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				syntax1Struct syntax1 = new syntax1Struct();
				row2Struct row2 = new row2Struct();
				syntax2Struct syntax2 = new syntax2Struct();
				...
				util_tLogRow_2.addRow(new String[] { "newColumn", "newColumn1", "newColumn2", });
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "syntax1");
				}
				...
				util_tLogRow_3.addRow(new String[] { "newColumn", "newColumn1", "newColumn2", });
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "syntax2");
				}
...
// # Outputs initialization
				syntax1Struct syntax1_tmp = new syntax1Struct();
				syntax2Struct syntax2_tmp = new syntax2Struct();
// ###############################
				...
				try {
					String content_tFileInputRaw_1 = org.apache.commons.io.FileUtils.readFileToString(
							new java.io.File("/home/devsc/Talend/data/samples/sampleJson.txt"), "UTF-8");
					row1.content = content_tFileInputRaw_1;
					globalMap.put("tFileInputRaw_1_FILENAME_PATH", "/home/devsc/Talend/data/samples/sampleJson.txt");
...
// # Output table : 'syntax1'
					syntax1_tmp.content = row1.content;
					syntax1 = syntax1_tmp;

// # Output table : 'syntax2'
					syntax2_tmp.content = row1.content;
					syntax2 = syntax2_tmp;
// ###############################
...
// Start of branch "syntax1"
				if (syntax1 != null) {
					...
					if (syntax1.content != null) {// C_01
						jsonStr_tExtractJSONFields_1 = syntax1.content.toString();

						row2 = null;

						String loopPath_tExtractJSONFields_1 = "$.person.emergencyContacts.[*]";
						...
						for (int i_tExtractJSONFields_1 = 0; isStructError_tExtractJSONFields_1
							...
							if (!isStructError_tExtractJSONFields_1) {
								...
								try {
									jsonPath_tExtractJSONFields_1 = "$[\'n.ame\']";
									...
									try {
										...
										row2.newColumn = value_tExtractJSONFields_1 == null ?
									...
									try {
										...
										row2.newColumn1 = value_tExtractJSONFields_1 == null ?
									...
									jsonPath_tExtractJSONFields_1 = "relationship";
									compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1
											.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
									...
									try {
										...
										row2.newColumn2 = value_tExtractJSONFields_1 == null ?
...
///////////////////////		
								...
								if (row2.newColumn != null) { //
									row_tLogRow_2[0] = String.valueOf(row2.newColumn);

								} //

								if (row2.newColumn1 != null) { //
									row_tLogRow_2[1] = String.valueOf(row2.newColumn1);

								} //

								if (row2.newColumn2 != null) { //
									row_tLogRow_2[2] = String.valueOf(row2.newColumn2);
...
///////////////////////    			
				...
				} // End of branch "syntax1"

// Start of branch "syntax2"
				if (syntax2 != null) {
					...
					if (syntax2.content != null) {// C_01
						jsonStr_tExtractJSONFields_2 = syntax2.content.toString();

						row3 = null;

						String loopPath_tExtractJSONFields_2 = "$.person.emergencyContacts.[*]";
						...
						for (int i_tExtractJSONFields_2 = 0; isStructError_tExtractJSONFields_2
							...
							if (!isStructError_tExtractJSONFields_2) {
								...
								try {
									jsonPath_tExtractJSONFields_2 = "$.n.ame";
									...
									try {
										...
										row3.newColumn = value_tExtractJSONFields_2 == null ?
									...
									jsonPath_tExtractJSONFields_2 = "phone";
									compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
											.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
									...
									try {
										...
										row3.newColumn1 = value_tExtractJSONFields_2 == null ?
									...
									jsonPath_tExtractJSONFields_2 = "relationship";
									compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2
											.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
									...
									try {
										...
										row3.newColumn2 = value_tExtractJSONFields_2 == null ?
...
///////////////////////		
								...
								if (row3.newColumn != null) { //
									row_tLogRow_3[0] = String.valueOf(row3.newColumn);

								} //

								if (row3.newColumn1 != null) { //
									row_tLogRow_3[1] = String.valueOf(row3.newColumn1);

								} //

								if (row3.newColumn2 != null) { //
									row_tLogRow_3[2] = String.valueOf(row3.newColumn2);
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "syntax1");
				}
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "syntax2");
				}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final jsonExtract jsonExtractClass = new jsonExtract();

		int exitCode = jsonExtractClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jsonExtract.class.getClassLoader()
					.getResourceAsStream("local_project/jsonextract_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jsonExtract.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jsonExtract");
		}
...
/************************************************************************************************
 * 81636 characters generated by Talend Open Studio for ESB on the March 24,
 * 2023 at 12:09:50 PM EDT
 ************************************************************************************************/