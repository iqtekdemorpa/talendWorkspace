...
package local_project.simplerest_0_1;
 ...
 * @status
 */
public class simpleRest implements TalendJob {
	...
	private final String jobName = "simpleRest";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(simpleRest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public String getRestEndpoint() {
		return "http://localhost:8088/apiproxy";
	}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final simpleRest job;

		public RestServiceProviderImpl4TalendJob(simpleRest job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, simpleRest job) {
		...
		public javax.ws.rs.core.Response mainFlow(
			...
			request_tRESTRequest_1.put("OPERATION", "mainFlow");
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(simpleRest job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = simpleRest.class.getClassLoader()
					.getResourceAsStream("local_project/simplerest_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = simpleRest.class.getClassLoader()
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_simpleRest = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_simpleRest = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_simpleRest) {
	...
	public static class mainFlowStruct implements routines.system.IPersistableRow<mainFlowStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_simpleRest = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_simpleRest = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_simpleRest.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_simpleRest.length == 0) {
						commonByteArray_LOCAL_PROJECT_simpleRest = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_simpleRest = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_simpleRest, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_simpleRest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_simpleRest, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_simpleRest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_simpleRest) {
				...
				try {
					...
					this.meta = readString(dis);

					this.Accept = readString(dis);

					this.AcceptEncoding = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.AcceptEncoding, dos);

				// String

				writeString(this.UserAgent, dos);
		...
		public String toString() {
			...
			sb.append(",AcceptEncoding=" + AcceptEncoding);
		 ...
		 * Compare keys
		 */
		public int compareTo(mainFlowStruct other) {
	...
	public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				mainFlowStruct mainFlow = new mainFlowStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(iterateId, 0, 0, "mainFlow", "out1");
				}
				...
				try {
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "mainFlow");
					}
...
//    	this.treeNodeAPI = treeNodeAPI;
						...
						// input table.
						void generateElements(boolean isInnerJoin, mainFlowStruct mainFlow,
...
// build root xml tree 
							if (needRoot) {
								...
								root_0 = root.addElement("meta");
								org.dom4j.Element root_0_1 = null;
								root_0_1 = root_0.addElement("Accept");
								valueMap.put("root_0_1", mainFlow.Accept);
								...
								root_0_2 = root_0.addElement("meta");
								valueMap.put("root_0_2", mainFlow.meta);
								...
								root_0_3 = root_0.addElement("AcceptEncoding");
								valueMap.put("root_0_3", mainFlow.AcceptEncoding);
								...
								root_0_4 = root_0.addElement("UserAgent");
								valueMap.put("root_0_4", mainFlow.UserAgent);
					...
					if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
						...
						java.util.Map<String, Object> params_tRESTRequest_1 = (java.util.Map<String, Object>) requestMessage_tRESTRequest_1
								.get("PARAMS");
						if (matchedFlow_tRESTRequest_1.equals("mainFlow")) {
							mainFlow = new mainFlowStruct();
							if (params_tRESTRequest_1.containsKey("PATH:meta:id_String")) {

								mainFlow.meta = (String) params_tRESTRequest_1.get("PATH:meta:id_String");

							}
							if (params_tRESTRequest_1.containsKey("HEADER:Accept:id_String")) {

								mainFlow.Accept = (String) params_tRESTRequest_1.get("HEADER:Accept:id_String");

							}
							if (params_tRESTRequest_1.containsKey("HEADER(ACCEPT-ENCODING):AcceptEncoding:id_String")) {

								mainFlow.AcceptEncoding = (String) params_tRESTRequest_1
										.get("HEADER(ACCEPT-ENCODING):AcceptEncoding:id_String");

							}
							if (params_tRESTRequest_1.containsKey("HEADER(USER-AGENT):UserAgent:id_String")) {

								mainFlow.UserAgent = (String) params_tRESTRequest_1
										.get("HEADER(USER-AGENT):UserAgent:id_String");
...
// Start of branch "mainFlow"
					if (mainFlow != null) {
						...
						GenerateDocument_out1 gen_Doc_out1_tXMLMap_1 = new GenerateDocument_out1();
						out1_tmp.body = null;
...
// # Output table : 'out1'
							...
							gen_Doc_out1_tXMLMap_1.generateElements(rejectedDocInnerJoin_tXMLMap_1, mainFlow, Var);

							if (out1_tmp.body == null) {
								out1_tmp.body = new routines.system.Document();
								out1_tmp.body.setDocument(gen_Doc_out1_tXMLMap_1.getDocument());
							}
...
// Start of branch "out1"
						if (out1 != null) {
							...
							if (null == outputStream_tRESTResponse_1 && responseAlreadySent_tRESTResponse_1) {
								...
								if (null != out1.body) {
									restProviderResponse_tRESTResponse_1 = out1.body.getDocument();
								}
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "mainFlow");
					}
				...
				if (execStat) {
					runStat.updateStatOnConnection(iterateId, 2, 0, "mainFlow", "out1");
				}
	...
	public static void main(String[] args) {
		final simpleRest simpleRestClass = new simpleRest();

		int exitCode = simpleRestClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = simpleRest.class.getClassLoader()
					.getResourceAsStream("local_project/simplerest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = simpleRest.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : simpleRest");
		}
...
/************************************************************************************************
 * 78358 characters generated by Talend Open Studio for ESB on the February 26,
 * 2023 at 3:25:34 PM EST
 ************************************************************************************************/